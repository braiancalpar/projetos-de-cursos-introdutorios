...
const arrayA = ["Renarien", "Tueli", "Kouth"];
const arrayB = ["Sorem", "Keldorn", "Roberto"];
...
console.log(concatena(arrayA, arrayB));

// 2 - Crie um array chamado numeros contendo números de 1 a 10. Utilize o método slice para criar um novo array chamado parteNumeros
...
// 5 - Crie uma lista bidimensional com 3 linhas e 3 colunas, onde cada elemento seja uma matriz 3x3 com valores iniciando em 1 e aumentando
// em 1 a cada elemento.
// Dicas:
